...
#### custom parameters #####
model_path = '/data11/shenxu/msrvtt_models/pool_vae_v2s/'
batch_size = 1024
learning_rate = 0.01
#### custom parameters #####
...
class Video_Caption_Generator():
    ...
    def build_model(self, video, video_mask, caption, caption_1, caption_mask,
        drop_sent='keep', drop_video='keep', caption_weight=1., video_weight=1., latent_weight=0.01):
...
def train():
    ...
    with tf.device("/gpu:0"):
        tf_loss, tf_loss_cap, tf_loss_lat, tf_loss_vid, tf_z = model.build_model(train_data, train_video_label, \
            train_caption_id, train_caption_id_1, train_caption_label, drop_sent='totally', drop_video='keep', video_weight=0., caption_weight=1.)
