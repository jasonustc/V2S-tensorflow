        ...
        if video_name in re.keys():
            ...
            for xxx in caps:
                ...
                if len(xxx.split(' ')) < 35:
                    ...
                    capl[:n_words + 1] = 1
                    write_data_as_record(writer, data, encode_data, video_name, title, vl, capl,
                        cap_id, cap_id_1, cap_id_2, cap_id_3, cap_id_4, cap_id_5)
                    print 'data:', data[0, 150: 170]
                    print 'encode_data:', encode_data[0, 150: 170]
                    print 'video_label:', vl[0, :]
                    print 'caption_label:', capl[0, :]
                    print 'caption_id:', cap_id[0, :]
                    print 'caption_id_1:', cap_id_1[0, :]
                    print 'caption_id_2:', cap_id_2[0, :]
                    print 'caption_id_3:', cap_id_3[0, :]
                    print 'caption_id_4:', cap_id_4[0, :]
                    print 'caption_id_5:', cap_id_5[0, :]
                    cnt += 1
