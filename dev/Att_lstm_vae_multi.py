...
###### custom parameters #######
model_path = '/home/shenxu/V2S-tensorflow/models/att_lstm_vae_multi/'
###### custom parameters #######
...
def train():
    ...
    # graph on the GPU
    with tf.device("/gpu:0"):
        tf_loss, tf_loss_cap, tf_loss_lat, tf_loss_vid, tf_z = model.build_model(train_data, train_encode_data, train_video_label, \
