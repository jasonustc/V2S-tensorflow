...
class Video_Caption_Generator():
    ...
    def build_model(self, video_feat, frames, video_mask, caption, caption_1, caption_mask):
        ...
        if drop_type == 1:
            ...
            state2[0] = c_init
            state2[0] = tf.stop_gradient(state2[0])
        elif drop_type == 2:
        ...
        ######## Decoding Stage ##########
        state3 = (state2[0], output_semantic) # 2 x b x h
        state4 = (state2[0], output_semantic) # 2 x b x h
    ...
    def build_s2s_generator(self, caption_1):
        ...
        ####### Decoding ########
        state3 = (state2[0], output_semantic) # n x 2 x h
        current_embed = tf.zeros([self.batch_size, self.dim_hidden]) # b x h
