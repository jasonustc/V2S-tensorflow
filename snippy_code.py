...
def convert_idx2word(word_file):
    assert os.path.isfile(word_file)
    idx2word = {}
...
#    label = get_hdf5_data('test_data/19.h5', 'label')
    idx2word = convert_idx2word('/home/shenxu/lstm/v2s_rbm/msr_vtt_vocabulary.txt')
    np.save('test_data/ixtoword', idx2word)
    pdb.set_trace()
